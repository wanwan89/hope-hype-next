...
export default function HeaderRoom({
  ...
  // State untuk mengontrol animasi teks "+ Follow" menjadi "+"
  const [isFollowExpanded, setIsFollowExpanded] = useState(true);

  useEffect(() => {
    // Mengecilkan tombol follow setelah 3 detik
    ...
    >
      ...
      <motion.div 
        ...
        style={{
          ...
          padding: '4px 10px 4px 4px', // Padding diperkecil
          borderRadius: '30px',
      ...
      >
        ...
        {/* Tombol Follow dengan Animasi Shrink (Mengecil jadi +) */}
        <AnimatePresence>
          {roomInfo.ownerId && roomInfo.ownerId !== myUserId && !isFollowingHost && (
            <motion.button 
              ...
              exit={{ scale: 0, opacity: 0, width: 0, marginLeft: 0, padding: 0 }}
              whileTap={{ scale: 0.9 }}
      ...
      {/* BLOK KANAN: TOP GIFTERS & ONLINE COUNT (DIPISAH) */}
      <div style={{ display: 'flex', alignItems: 'center', gap: '6px' }}>
        ...
        {/* Pill 2: Jumlah Penonton Terpisah (Tanpa Ikon) */}
        <div 
          style={{ 
            display: 'flex', 
            alignItems: 'center', 
