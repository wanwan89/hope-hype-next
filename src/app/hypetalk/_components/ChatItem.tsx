...
const ChatItem: React.FC<Props> = ({
  chat, typingStatus, mutedChats, onlineUsers, currentUser,
  onOpenChat, onAvatarClick, renderReadReceipt
}) => {
  ...
  return (
    <div className="tg-chat-item" onClick={() => onOpenChat(chat)}>
      <div className="tg-avatar global-avatar" style={{ position: 'relative' }} onClick={(e) => onAvatarClick(e, chat.id, chat.type)}>
