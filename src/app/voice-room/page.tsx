...
export default function VoiceLobbyPage() {
  ...
  return (
    <>
      <style>{`
        /* Memaksa background gelap HypeTalk saat mode dark aktif */
        [data-theme='dark'] .voice-lobby-container,
        html.dark .voice-lobby-container,
        body.dark .voice-lobby-container {
